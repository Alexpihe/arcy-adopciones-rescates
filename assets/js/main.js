...
const generalDownloadButton = document.querySelector("[data-general-download]");
...
generalDownloadButton?.addEventListener("click", () => {
  openPrivacyDialog(generalDownloadButton);
});
